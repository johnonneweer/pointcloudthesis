...
import argparse
import os
from data_utils.AHN3DataLoader import AHNDatasetWholeScene
...
def main(args):
    ...
    TEST_DATASET_WHOLE_SCENE = AHNDatasetWholeScene(root, split='test', test_area=args.test_area, block_points=NUM_POINT)
