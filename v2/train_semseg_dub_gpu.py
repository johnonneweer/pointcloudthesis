...
def main(args):
    ...
    TRAIN_DATASET = DublinDataset(split='train', data_root=root, num_point=NUM_POINT, train_area=args.train_area, block_size=10.0, sample_rate=1.0, transform=None)
    print("start loading test data ...")
    TEST_DATASET = DublinDataset(split='test', data_root=root, num_point=NUM_POINT, test_area=args.test_area, block_size=10.0, sample_rate=1.0, transform=None)
