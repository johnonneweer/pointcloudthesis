...
import argparse
import os
from data_utils.DublinDataLoader import DublinDatasetWholeScene
...
def parse_args():
    ...
    parser.add_argument('--test_area', type=str, default='utr', help='Which area to use for test, option: 1-6 [default: utr]')
...
def main(args):
    ...
    TEST_DATASET_WHOLE_SCENE = DublinDatasetWholeScene(root, split='test', test_area=args.test_area, block_points=NUM_POINT)
